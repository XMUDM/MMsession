...
class RGCN(nn.Module):
    def __init__(self, in_feats, out_feats):
        ...
        self.conv1 = dglnn.HeteroGraphConv({
            rel_names[0]: dglnn.GATConv(in_feats, out_feats, num_heads=1),
            rel_names[1]: dglnn.GATConv(in_feats, out_feats, num_heads=1),
            rel_names[2]: dglnn.GATConv(in_feats, out_feats, num_heads=1)}, aggregate='sum')
...
if __name__ == "__main__":
    test = False
    save_path = config.save_path+"_double_pos2neg2view1"
